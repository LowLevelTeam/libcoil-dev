...
TEST_CASE("Operand creation", "[instr]") {
  ...
  SECTION("Immediate integer operands") {
      // I8 operand
      coil::Operand op8 = coil::createImmOpInt(42, coil::ValueType::I8);
      CHECK(op8.type == coil::OperandType::Imm);
      CHECK(op8.value_type == coil::ValueType::I8);
      CHECK(op8.imm.i8_val == 42);
      
      // I16 operand
      coil::Operand op16 = coil::createImmOpInt(1000, coil::ValueType::I16);
      CHECK(op16.type == coil::OperandType::Imm);
      CHECK(op16.value_type == coil::ValueType::I16);
      CHECK(op16.imm.i16_val == 1000);
      
      // I32 operand
      coil::Operand op32 = coil::createImmOpInt(1000000, coil::ValueType::I32);
      CHECK(op32.type == coil::OperandType::Imm);
      CHECK(op32.value_type == coil::ValueType::I32);
      CHECK(op32.imm.i32_val == 1000000);
      
      // I64 operand
      coil::Operand op64 = coil::createImmOpInt(1000000000000LL, coil::ValueType::I64);
      CHECK(op64.type == coil::OperandType::Imm);
      CHECK(op64.value_type == coil::ValueType::I64);
      CHECK(op64.imm.i64_val == 1000000000000LL);
      
      // U8 operand
      coil::Operand uop8 = coil::createImmOpInt(200, coil::ValueType::U8);
      CHECK(uop8.type == coil::OperandType::Imm);
      CHECK(uop8.value_type == coil::ValueType::U8);
      CHECK(uop8.imm.u8_val == 200);
  }
...
TEST_CASE("Instruction block", "[instr]") {
