...
/**
 * @brief Section information structure
 */
...
/**
 * @brief Initialize a default object header
 * 
...
/**
 * @brief Allocate memory either from arena or heap
 * 
 * @param arena Arena to use (can be NULL for malloc)
...
/**
 * @brief Push data to arena or copy to heap
 * 
 * @param arena Arena to use (can be NULL for malloc/memcpy)
 * @param data Data to copy
 * @param size Size of data
 * @return void* Pointer to copied data or NULL on failure
 */
...
/**
 * @brief Free memory if not using arena
 * 
 * @param ptr Memory to free
 * @param uses_arena Whether memory is from arena
 */
 ...
 * @return coil_u16_t Section index (1-based, 0 if not found)
 */
...
/**
 * @brief Add a string to the string table section
 * 
 * @param obj Pointer to the object
 * @param str String to add
 * @param arena Arena for memory allocation
 * @return coil_u64_t Offset of string in table, or 0 on error
 */
